...
// Placeholder: when a milk batch is selected, supplier_id could be auto-derived
watch(() => form.milk_batch_id, (newVal) => {
    // form.supplier_id = ... // if batch maps to supplier later
});
                ...
                <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white">
                    ...
                    <div class="block w-full overflow-x-auto px-8 py-4">
                        <div class="grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
                            ...
                            <div class="flex flex-col">
                                <label for="milk_batch" class="text-stone-600 text-sm font-medium">Select Milk Batch</label>
                                <AsyncVueSelect
                                    v-model="form.milk_batch_id"
                                    resource="milk.batches.index"
                                    resourceLabel="batch_no"
                                    placeholder="Select milk batch"
                                    class="mt-2"
                                />
                                <InputError :message="form.errors.milk_batch_id"/>
                            </div>
                            <div class="flex flex-col">
                            ...
                            <!-- Supplier Location hidden as requested -->
                            <!--
                            <div class="flex flex-col">
                            ...
                            -->
                            <div class="flex flex-col">
                                <label for="buying_date" class="text-stone-600 text-sm font-medium">Production Date</label>
                                <input
                                    id="buying_date"
                            ...
                            <div class="flex flex-col">
                                <label for="buying_price" class="text-stone-600 text-sm font-medium">Packaging Cost</label>
                                <input
                                    id="buying_price"
