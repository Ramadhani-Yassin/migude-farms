    ...
    <AuthenticatedLayout>
        ...
        <Modal title="Create" :show="showCreateModal" :formProcessing="form.processing" @close="closeModal" @submitAction="createExpense">
            ...
            <div class="mt-3">
                ...
                <input id="amount" v-model="form.amount" type="number" step="0.01" placeholder="Enter amount" class="px-3 py-2 rounded border w-full" />
                <InputError :message="form.errors.amount" />
            </div>
            <div class="mt-3">
                <label for="expense_date">Expense Date</label>
                <input id="expense_date" v-model="form.expense_date" type="date" class="px-3 py-2 rounded border w-full" />
                <InputError :message="form.errors.expense_date" />
            </div>
            <div class="mt-3">
                <label for="description">Description</label>
                <textarea id="description" v-model="form.description" placeholder="Enter description" class="px-3 py-2 rounded border w-full"></textarea>
