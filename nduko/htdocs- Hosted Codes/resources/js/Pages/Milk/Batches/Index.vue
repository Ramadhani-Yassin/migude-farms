...
const tableHeads = ref(['#', 'Date', 'Person', 'Batch No', 'Volume (L)', 'Unit Price', 'Purchasing Cost', 'Labour', 'Expenses', 'Total Expenses', 'Total Sales', 'Action']);
            ...
            <div class="w-full px-4">
                ...
                >
                    ...
                    <tr v-for="(batch, index) in batches.data" :key="batch.id">
                        ...
                        <TableData>{{ batch.total_sales_expected ?? '-' }}</TableData>
                        <TableData>
