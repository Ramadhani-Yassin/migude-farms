                        ...
                        <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                            <div class="pr-12">
                                <h1 class="text-white font-semibold text-5xl">
                                    Migude Green Farms Management Portal.
                                </h1>
                                <p class="mt-4 text-lg text-blueGray-200">
                                    We are committed to providing the highest quality dairy and farm products. 
                                    Located in Milo, Ruvu, Tanzania, we believe in nurturing nature to nourish lives. 
                                    Our approach is rooted in sustainability, care for the environment, and respect for the animals we raise. 
                                </p>
                                <Link
